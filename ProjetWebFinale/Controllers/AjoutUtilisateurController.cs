...
namespace ProjetWebFinale.Controllers
{
    public class AjoutUtilisateurController : Controller
    {
        ...
        public AjoutUtilisateurController(FilmDbContext context, UserManager<Utilisateurs> userManager, SignInManager<Utilisateurs> signInManager)
        {
            _context = context;
        ...
        {
            IEnumerable<TypesUtilisateur> liste = _context.TypesUtilisateur.Except(_context.TypesUtilisateur.Where(u => u.Identifiant == 'A'));
        ...
        public async Task<IActionResult> Create([Bind("Nom,Courriel,MotDePasse,ConfirmerMotDePasse,TypeUtilisateur")] RegisterViewModel model)
        {
